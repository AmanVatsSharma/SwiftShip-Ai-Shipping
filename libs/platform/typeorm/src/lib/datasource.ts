...
export const buildDataSourceOptions = (): DataSourceOptions => ({
  ...
  migrations: [
    AddTenantId1718160000000,
    AddWalletTables1718160000001,
    ValidateTenantIdFKs1718160000002,
    AddRateZoneMatrix1718160000003,
    AddOrderRateQuotes1718160000004,
    AddNdrCases1718160000005,
    AddRtoDisputes1718160000006,
    AddKycTables1718160000010,
    AddGstInvoiceTables1718160000011,
    AddCodRemittanceTables1718160000013,
    AddAuditLogTable1718160000014,
    AddChannelSyncTables1718160000015,
  ],
