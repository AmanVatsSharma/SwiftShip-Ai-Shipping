...
export class ShopifyOrder {
  ...
  @Field(() => String, {
    description: 'The ID of the Shopify store this order belongs to',
  })
  storeId!: string;
  ...
  @Field(() => String, {
    description: 'Customer email associated with this order',
    nullable: true,
  })
  ...
  @Field(() => Date, {
    description: 'When the order was created in our system',
  })
  createdAt!: Date;

  @Field(() => Date, {
    description: 'When the order was last updated in our system',
    nullable: true,
  })
  updatedAt?: Date;
}
