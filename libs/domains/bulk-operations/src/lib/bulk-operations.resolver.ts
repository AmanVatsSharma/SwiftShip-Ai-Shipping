...
import { GqlAuthGuard } from '@swiftship/platform-auth';
...
export class BulkOperationsResolver {
  ...
  @Mutation(() => BulkLabelResult, {
    description: 'Generate labels for multiple shipments',
  })
  ...
  @Mutation(() => BulkOperationResult, {
    description: 'Schedule pickups for multiple shipments',
  })
  @UseGuards(GqlAuthGuard)
  ...
  @Mutation(() => BulkOperationResult, {
    description: 'Process multiple orders in batch',
  })
  @UseGuards(GqlAuthGuard)
  ...
  @Mutation(() => Object, {
    description: 'Generate manifest for multiple shipments',
  })
  @UseGuards(GqlAuthGuard)
